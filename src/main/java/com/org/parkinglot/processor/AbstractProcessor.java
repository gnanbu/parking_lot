package com.org.parkinglot.processor;

import com.org.parkinglot.constant.Operations;
import com.org.parkinglot.domain.Car;
...
public abstract class AbstractProcessor {
	...
	public void validateAndProcess(String inputString) throws Exception {
		...
		Operations command = Operations.findByName(inputStrArr[0]);
